...
PCAN_BAUD_666K           = TPCANBaudrate(0x4018) # 666.666 kBit/s
...
class PCANBasic:
    ...
    def InitializeFD(
		...
		Example:
          f_clock_mhz=80,nom_brp=0,nom_tseg1=13,nom_tseg2=0,nom_sjw=0,data_brp=0,data_tseg1=13,data_tseg2=0,data_sjw=0
